...
min = LIMIT minrec 1;
STORE min INTO 'openflight/georgenp/lab5/data/output' using PigStorage('\t');
max = LIMIT maxrec 1;
STORE max INTO 'openflight/georgenp/lab5/data/output' using PigStorage('\t');
grouped = GROUP frecords ALL;
avg = FOREACH grouped GENERATE AVG(frecords.temp);
STORE avg INTO 'openflight/georgenp/lab5/data/output' using PigStorage('\t');