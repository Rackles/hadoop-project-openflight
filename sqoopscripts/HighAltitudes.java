// ORM class for table 'HighAltitudes'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon May 06 03:42:10 UTC 2019
...
public class HighAltitudes extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        HighAltitudes.this.id = (String)value;
      }
    });
    setters.put("name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HighAltitudes.this.name = (String)value;
      }
    });
    setters.put("city", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HighAltitudes.this.city = (String)value;
      }
    });
    setters.put("country", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HighAltitudes.this.country = (String)value;
      }
    });
    setters.put("iata", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HighAltitudes.this.iata = (String)value;
      }
    });
    setters.put("alt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HighAltitudes.this.alt = (java.math.BigDecimal)value;
      }
    });
    setters.put("latitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HighAltitudes.this.latitude = (java.math.BigDecimal)value;
      }
    });
    setters.put("longitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HighAltitudes.this.longitude = (java.math.BigDecimal)value;
      }
    });
  }
  public HighAltitudes() {
    init0();
  }
  private String id;
  ...
  public HighAltitudes with_id(String id) {
    this.id = id;
    return this;
  }
  private String name;
  ...
  public HighAltitudes with_name(String name) {
    this.name = name;
    return this;
  }
  private String city;
  ...
  public HighAltitudes with_city(String city) {
    this.city = city;
    return this;
  }
  ...
  public HighAltitudes with_country(String country) {
    this.country = country;
    return this;
  }
  private String iata;
  ...
  public HighAltitudes with_iata(String iata) {
    this.iata = iata;
    return this;
  }
  private java.math.BigDecimal alt;
  public java.math.BigDecimal get_alt() {
    return alt;
  }
  public void set_alt(java.math.BigDecimal alt) {
    this.alt = alt;
  }
  public HighAltitudes with_alt(java.math.BigDecimal alt) {
    this.alt = alt;
    return this;
  }
  ...
  public HighAltitudes with_latitude(java.math.BigDecimal latitude) {
    this.latitude = latitude;
    return this;
  }
  ...
  public HighAltitudes with_longitude(java.math.BigDecimal longitude) {
    this.longitude = longitude;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof HighAltitudes)) {
      return false;
    }
    HighAltitudes that = (HighAltitudes) o;
    boolean equal = true;
    ...
    equal = equal && (this.alt == null ? that.alt == null : this.alt.equals(that.alt));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.alt = JdbcWritableBridge.readBigDecimal(6, __dbResults);
    this.latitude = JdbcWritableBridge.readBigDecimal(7, __dbResults);
    this.longitude = JdbcWritableBridge.readBigDecimal(8, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(alt, 6 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(latitude, 7 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(longitude, 8 + __off, 3, __dbStmt);
    return 8;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.alt = org.apache.sqoop.lib.BigDecimalSerializer.readFields(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.latitude = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.alt) { 
        ...
        __dataOut.writeBoolean(false);
    org.apache.sqoop.lib.BigDecimalSerializer.write(this.alt, __dataOut);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(alt==null?"null":alt.toPlainString(), delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("\\N") || __cur_str.length() == 0) { this.alt = null; } else {
      this.alt = new java.math.BigDecimal(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    HighAltitudes o = (HighAltitudes) super.clone();
    return o;
  }

  public void clone0(HighAltitudes o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("alt", this.alt);
