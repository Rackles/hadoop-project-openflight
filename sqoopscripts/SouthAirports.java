// ORM class for table 'SouthAirports'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon May 06 04:02:59 UTC 2019
...
public class SouthAirports extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        SouthAirports.this.id = (String)value;
      }
    });
    setters.put("name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        SouthAirports.this.name = (String)value;
      }
    });
    setters.put("city", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        SouthAirports.this.city = (String)value;
      }
    });
    setters.put("country", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        SouthAirports.this.country = (String)value;
      }
    });
    setters.put("iata", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        SouthAirports.this.iata = (String)value;
      }
    });
    setters.put("latitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        SouthAirports.this.latitude = (java.math.BigDecimal)value;
      }
    });
    setters.put("longitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        SouthAirports.this.longitude = (java.math.BigDecimal)value;
      }
    });
  }
  public SouthAirports() {
    init0();
  }
  private String id;
  ...
  public SouthAirports with_id(String id) {
    this.id = id;
    return this;
  }
  private String name;
  ...
  public SouthAirports with_name(String name) {
    this.name = name;
    return this;
  }
  private String city;
  ...
  public SouthAirports with_city(String city) {
    this.city = city;
    return this;
  }
  ...
  public SouthAirports with_country(String country) {
    this.country = country;
    return this;
  }
  private String iata;
  ...
  public SouthAirports with_iata(String iata) {
    this.iata = iata;
    return this;
  }
  ...
  public SouthAirports with_latitude(java.math.BigDecimal latitude) {
    this.latitude = latitude;
    return this;
  }
  ...
  public SouthAirports with_longitude(java.math.BigDecimal longitude) {
    this.longitude = longitude;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SouthAirports)) {
      return false;
    }
    SouthAirports that = (SouthAirports) o;
    boolean equal = true;
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    SouthAirports o = (SouthAirports) super.clone();
    return o;
  }

  public void clone0(SouthAirports o) throws CloneNotSupportedException {
  }
