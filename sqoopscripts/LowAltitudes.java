// ORM class for table 'LowAltitudes'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Mon May 06 03:51:02 UTC 2019
...
public class LowAltitudes extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        LowAltitudes.this.id = (String)value;
      }
    });
    setters.put("name", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LowAltitudes.this.name = (String)value;
      }
    });
    setters.put("city", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LowAltitudes.this.city = (String)value;
      }
    });
    setters.put("country", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LowAltitudes.this.country = (String)value;
      }
    });
    setters.put("iata", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LowAltitudes.this.iata = (String)value;
      }
    });
    setters.put("alt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LowAltitudes.this.alt = (java.math.BigDecimal)value;
      }
    });
    setters.put("latitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LowAltitudes.this.latitude = (java.math.BigDecimal)value;
      }
    });
    setters.put("longitude", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LowAltitudes.this.longitude = (java.math.BigDecimal)value;
      }
    });
  }
  public LowAltitudes() {
  ...
  public LowAltitudes with_id(String id) {
    this.id = id;
    return this;
  }
  private String name;
  ...
  public LowAltitudes with_name(String name) {
    this.name = name;
    return this;
  }
  private String city;
  ...
  public LowAltitudes with_city(String city) {
    this.city = city;
    return this;
  }
  ...
  public LowAltitudes with_country(String country) {
    this.country = country;
    return this;
  }
  private String iata;
  ...
  public LowAltitudes with_iata(String iata) {
    this.iata = iata;
    return this;
  }
  ...
  public LowAltitudes with_alt(java.math.BigDecimal alt) {
    this.alt = alt;
    return this;
  }
  ...
  public LowAltitudes with_latitude(java.math.BigDecimal latitude) {
    this.latitude = latitude;
    return this;
  }
  ...
  public LowAltitudes with_longitude(java.math.BigDecimal longitude) {
    this.longitude = longitude;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof LowAltitudes)) {
      return false;
    }
    LowAltitudes that = (LowAltitudes) o;
    boolean equal = true;
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    LowAltitudes o = (LowAltitudes) super.clone();
    return o;
  }

  public void clone0(LowAltitudes o) throws CloneNotSupportedException {
  }
