...
routesWithAirline = JOIN routesWithCoordinates BY routes::airlineIATA, airlines by iata;

r_w_a = FOREACH routesWithAirline GENERATE airportsSourceRoutes::routes::source AS sname, airportsSourceRoutes::routes::destination AS dname, sLat, sLong, dLat, dLong, name, iata;
