...
routesWithAirline = JOIN routesWithCoordinates BY airportsSourceRoutes.airlineIATA, airlines by iata;

r_w_a = FOREACH routesWithAirline GENERATE airportsSourceRoutes.source AS sname, airportsDestRoutes.destination AS dname, sLat, sLong, dLat, dLong, name, iata;
